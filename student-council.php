...
<head>
    ...
    <title>Barnes School & Junior College | Student Council</title>
</head>
...
<body>
    ...
    <main>
                    ...
                    <div class="row">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Student Council</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="aboutUs studentCouncil">
            <div class="container">
                <div class="row">
