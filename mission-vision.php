...
<head>
    ...
    <title>Barnes School & Junior College | Mission Vision</title>
</head>
...
<body>
    ...
    <main>
        ...
        <section class="aboutUs missionVision">
            <div class="container">
                <div class="row">
                    <div class="wrapper flex-wrap flex-lg-nowrap">
                        <div class="contentCard">
                            <div class="content">
                                <div class="pgHeader">
                                    <div class="pgTitle">
                                        <h6 class="pgSection">Our Guiding Principles</h6>
                                        <h2>Mission vision</h2>
                                        <hr>
                                    </div>
                                </div>
                                <dl>
                                    <dt><i class="ph-duotone ph-target"></i> Our Mission</dt>
                                    <dd>Our mission is to provide holistic education that nurtures character, knowledge,
                                        creativity, and leadership, empowering students to excel with integrity. </dd>
                                </dl>
                                <dl>
                                    <dt><i class="ph-duotone ph-eye"></i> Our Vision</dt>
                                    <dd>Our vision is to be a centre of academic excellence, inspiring lifelong learners
                                        who contribute meaningfully to society with compassion.</dd>
                                </dl>
                            </div>
                        </div>
